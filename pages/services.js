    ...
    <Layout>
      ...
      <section className="work-process-area pt-130 pb-100 rpt-100 rpb-70 rel z-1">
        <div className="section-title text-center mb-70 wow fadeInUp delay-0-2s">
          <span className="sub-title mb-15">Hizmetler</span>
          <h2>Yenilikçi Fikirler ve Hızlı Sorun Çözümleri</h2>
        </div>
      ...
      <div className="video-area-two rel z-1">
        <div className="container">
          <div className="video-wrap-two wow fadeInUp delay-0-2s">
            <img src="assets/images/background/video1.jpg" alt="Video" />
            <a
              href="https://www.youtube.com/watch?v=VxijOyYIY_k"
