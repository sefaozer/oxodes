...
import OxodesAccordion from "@/src/components/OxodesAccordion";
          ...
          <Tab.Container defaultActiveKey={"faq-tab1"}>
            ...
            >
              ...
              <Tab.Pane className="tab-pane fade" eventKey="faq-tab2">
                <OxodesAccordion accordions={[1, 7, 8]} defaultActive={2} />
              </Tab.Pane>
              <Tab.Pane className="tab-pane fade" eventKey="faq-tab3">
                <OxodesAccordion accordions={[1, 2, 3]} defaultActive={2} />
              </Tab.Pane>
              <Tab.Pane className="tab-pane fade" eventKey="faq-tab4">
                <OxodesAccordion accordions={[6, 7, 8]} defaultActive={6} />
              </Tab.Pane>
              <Tab.Pane className="tab-pane fade" eventKey="faq-tab5">
                <OxodesAccordion accordions={[1, 2, 8]} defaultActive={8} />
              </Tab.Pane>
              <Tab.Pane className="tab-pane fade" eventKey="faq-tab6">
                <OxodesAccordion accordions={[1, 2, 3]} defaultActive={3} />
              </Tab.Pane>
              <Tab.Pane className="tab-pane fade" eventKey="faq-tab7">
                <OxodesAccordion accordions={[1, 7, 8]} defaultActive={1} />
              </Tab.Pane>
