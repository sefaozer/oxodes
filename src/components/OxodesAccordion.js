...
const OxodesAccordion = ({ defaultActive, accordions, accordionsData }) => {
...
export default OxodesAccordion;

const OxodesAccordion2 = ({ accordionsData }) => {
