      ...
      <Fragment>
        <div className="row justify-content-between align-items-end mb-30">
          <div className="col-lg-8">
            <div className="section-title mb-25 wow fadeInRight delay-0-2s">
              <span className="sub-title mb-15">Etkinlikler</span>
              <h2>Katıldığımız Fuar ve Etkinlikler</h2>
            </div>
          </div>
        ...
        >
          <div className="testimonial-item wow fadeInUp delay-0-2s">
            <div className="image">
              <img src="assets/images/testimonials/Fuar1.png" alt="Author" />
            </div>
            <div className="content">
              <div className="testi-header">
                <h4>Vivatech Paris/FRANSA</h4>
              </div>
              <div className="testi-text">
                Dolu dolu geçen Vivatech etkinliğinden sonra, bu hafta Paris'in
                girişimcilik ekosistemi ile toplantılar gerçekleştirdik.
                Paris'in en önemli girişimcilik merkezi Station F'de BNPP ve
                ImpulsePartners ile yurtdışı şirketleşme ve işbirliği
                toplantılarını gerçekleştirdik.
              </div>
